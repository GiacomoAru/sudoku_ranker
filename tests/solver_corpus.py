...
ACTIVE_TECHNIQUE_BINDINGS = {
    ...
    "0300": TechniqueBinding("fish:2", "fish.basic.2"),
    "0301": TechniqueBinding("fish:3", "fish.basic.3"),
    "0302": TechniqueBinding("fish:4", "fish.basic.4"),
